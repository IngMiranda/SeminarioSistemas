...
$fk_contacto=$_POST["txt_contacto"];//INSERT INTO `upemreferencias`.`contacto` (`correo`, `numero_celular`, `numero_telefono`, `contraseña`, `fk_plantel`) VALUES ('sa@gmail.com', '12123243', '32234545532', '23566', '1');
$fk_plantel=$_POST["txt_plantel1"];
...
$insertarnombre = mysqli_query($conn,"INSERT INTO usuario(`Nom_usuario`, `apellido_paterno`, `apellido_materno`, `fk_contacto`, `fk_plantel`, `fk_carrera`,`fk_modalidad`,`fk_beca`) values ('$nombre','$apellido_p','$apellido_m',$fk_contacto,$fk_plantel,$fk_carrera,$fk_modalidad,$fk_beca);");	
